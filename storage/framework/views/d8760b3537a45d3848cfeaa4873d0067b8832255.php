<div class="modal fade" id="update_<?php echo e($params->id); ?>" tabindex="-1" role="dialog" aria-hidden="true" data-modal="scroll">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo e(URL::route('section.update',$params->id)); ?>" method="post">
				<?php echo e(csrf_field()); ?>

				<div class="modal-body"> 
					<div class="form-group">
						<label for="demoTextInput1">Section</label>
						<input type="text" class="form-control" name="section" required value="<?php echo e($params->name); ?>">
					</div>  
					<div class="form-group">
						...
						<select class="form-control" name="level"> 
							<?php $__currentLoopData = $level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($v->id == $params->gradelevel_id): ?> selected <?php endif; ?> value="<?php echo e($v->id); ?>"><?php echo e($v->level); ?></option>  	
...
<?php /* /Users/mac/Desktop/gitlab/voting/resources/views/pages/section/modals/update.blade.php */ ?>