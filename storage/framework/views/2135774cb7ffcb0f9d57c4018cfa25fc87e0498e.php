...
<?php $__env->startSection('content'); ?>
	<div class="container">
		<form class="sign-in-form" method="post" action="<?php echo e(URL::route('admin.login.verify')); ?>" style="margin-top: 100px;">
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" id="inputEmail" class="form-control" placeholder="Username" required name="username" value="<?php echo e(old('username')); ?>">
					</div>
...
<?php /* /Users/mac/Desktop/gitlab/voting/resources/views/pages/auth/login/admin.blade.php */ ?>