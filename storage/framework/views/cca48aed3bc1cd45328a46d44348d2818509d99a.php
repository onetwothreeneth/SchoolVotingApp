		...
		<table cellpadding="0" cellspacing="0">
			<thead>
				<tr>
					...
					<?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<td style="background: red;"><?php echo e($v->name); ?></td> 
				...
				<?php if($data): ?>
					<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td></td>
							<?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lvl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<td></td> 
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<td></td>
						</tr>
						<?php if($v['data']): ?>
							...
							<?php $__currentLoopData = $v['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr <?php if($highlight): ?> style="background-color: lightblue;" <?php endif; ?>>
									...
									<?php $total = 0; ?>
									<?php $__currentLoopData = $cans['section']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lvlx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /* /Users/mac/Desktop/gitlab/voting/resources/views/pages/reports/print/sections.blade.php */ ?>