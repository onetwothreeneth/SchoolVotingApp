<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-hidden="true" data-modal="scroll">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo e(URL::route('partylist.add',[$election])); ?>" method="post">
...
<?php /* /Users/mac/Desktop/gitlab/voting/resources/views/pages/partylist/modals/add.blade.php */ ?>