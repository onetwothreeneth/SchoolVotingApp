...
@section('context')
										...
										@if($data)
											@foreach($data as $key => $v)
												<tr>
													...
													<td>{{ $v->level }}</td> 
													<td>
														{{ App\Models\Level::find($v->id)->schedule() }}
													</td> 
													<td>
													...
													<td>
														<div class="btn-group dropdown">
															...
															<div class="dropdown-menu" x-placement="bottom-start"> 
																...
																<a class="dropdown-item confirm-delete" href="{{ URL::route('level.delete',$v->id) }}">Delete</a> 
															</div>
														</div>
													</td>
												</tr>
	...
	@include('pages.level.modals.add')
	@if($data)
		@foreach($data as $key => $v)
			@include('pages.level.modals.update',['params' => $v])
		@endforeach
	@endif
@endsection 