...
@section('context')
											...
											@foreach($data as $key => $v)
												<tr>
													...
													<td>
														...
														{{ App\Models\Position::find($v->id)->level() }}
														@else 
															<b>ALL</b>
														@endif
													</td>
													...
													<td>
														<div class="btn-group dropdown">
															...
															<div class="dropdown-menu" x-placement="bottom-start"> 
																...
																<a class="dropdown-item confirm-delete" href="{{ URL::route('position.delete',$v->id) }}">Delete</a> 
															</div>
														</div>
													</td>
												</tr>
	...
	@include('pages.position.modals.add')
	@if($data)
		@foreach($data as $key => $v)
			@include('pages.position.modals.update',['params' => $v])
		@endforeach
	@endif
@endsection 